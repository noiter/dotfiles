...
S.bnda({
  ...
  // "f:ctrl;alt" : S.op("resize", { "x" : "screenOriginX", "y" : "screenOriginY", "width" : "screenSizeX", "height" : "screenSizeY"}),
  ...
  "up:ctrl;alt" : S.op("push", { "direction" : "up", "style" : "bar-resize:screenSizeY/2" }),
  "down:ctrl;alt" : S.op("push", { "direction" : "down", "style" : "bar-resize:screenSizeY/2" }),

  // Nudge Bindings
  // NOTE: some of these may *not* work if you have not removed the expose/spaces/mission control bindings
  "right:ctrl;shift" : S.op("nudge", { "x" : "+10%", "y" : "+0" }),
  "left:ctrl;shift" : S.op("nudge", { "x" : "-10%", "y" : "+0" }),
  "up:ctrl;shift" : S.op("nudge", { "x" : "+0", "y" : "-10%" }),
  "down:ctrl;shift" : S.op("nudge", { "x" : "+0", "y" : "+10%" }),
  ...
  "tab:ctrl;shift" : S.op("focus", { "direction" : "behind" }),
